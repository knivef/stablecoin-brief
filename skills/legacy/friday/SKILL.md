...
>
> This skill ran the Friday Stat + Snippet edition when Stablecoin Brief published three issues a
...
>    behave as written.
> 2. It writes to `editions/[YYYY-MM-DD]-friday/`, a folder naming convention no longer
